...
const GEIST_MONO_300 =
	"https://fonts.gstatic.com/s/geistmono/v6/or3yQ6H-1_WfwkMZI_qYPLs1a-t7PU0AbeFjKJ5T.ttf";
const LEXEND_300 =
...
const LEXEND_500 =
	"https://fonts.gstatic.com/s/lexend/v26/wlptgwvFAVdoq2_F94zlCfv0bz1WCwkW_LA.ttf";
	...
	if (kind === "site") {
		return (
			<svg width="18" height="18" viewBox="0 0 24 24" fill="none">
				...
				<path
					d="M3.5 12h17M12 3c2.4 2.6 3.6 5.6 3.6 9s-1.2 6.4-3.6 9c-2.4-2.6-3.6-5.6-3.6-9S9.6 5.6 12 3z"
					stroke="currentColor"
					strokeWidth="2"
					strokeLinecap="round"
...
export default async function OpengraphImage() {
	const [geistMono, lexend300, lexend400, lexend500] = await Promise.all(
		[GEIST_MONO_300, LEXEND_300, LEXEND_400, LEXEND_500].map((url) =>
